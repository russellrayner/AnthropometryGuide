document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupCollapsibleSections() {
        // First, collapse all sections by default
    ...
    const skinfoldData = {
        triceps: {
            ...
            instructions: `
                                <div class="collapsible-section">                    <h4 class="collapsible-header collapsed">Triceps Skinfold Site® Identification</h4>                    <div class="collapsible-content collapsed">
